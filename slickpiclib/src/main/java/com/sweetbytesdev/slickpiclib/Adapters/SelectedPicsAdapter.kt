...
class SelectedPicsAdapter : RecyclerView.Adapter<RecyclerView.ViewHolder>, HeaderItemDecoration.StickyHeaderInterface, SectionIndexer {
    companion object {
        val HEADER = 1
        val ITEM = 2
        val SPAN_COUNT = 3
    ...
    private val list: MutableList<Img>
    ...
    fun updateImageList(images: MutableList<Img>) {
        list.clear()
        list.addAll(images)
        notifyDataSetChanged()
    }

    fun getItemList(): MutableList<Img> {
        return list
    }
